    ...
    <> 
        <article className="post featured">
          <header className="major">
              <h1><a>Skills</a></h1>
              Here are some of the technologies and tools I've worked with in my journey as a .NET Fullstack Developer:
              <br/>
          </header>
          ...
          <ul className="actions special">
              <li><a href="#" className="button large">Go to top</a></li>
          </ul>
      </article>
    </>
  )
